...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    <!-- Zip Code Field -->
    <div class="form-group row ">
        {!! Form::label('zip_code', trans("lang.user_zip_code"), ['class' => 'col-3 control-label text-right']) !!}
        <div class="col-9">
            {!! Form::text('zip_code', null, ['class' => 'form-control','placeholder'=>  trans("lang.user_zip_code_placeholder")]) !!}
            <div class="form-text text-muted">
                {{ trans("lang.user_zip_code_help") }}
            </div>
        </div>
    </div>
</div>
