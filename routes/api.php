...
Route::get('login/apple/link', 'API\UserAPIController@create_apple_link');
Route::post('login/apple/handle', 'API\UserAPIController@login_with_apple');
Route::post('login/facebook', 'API\UserAPIController@login_with_facebook');
Route::post('login/google', 'API\UserAPIController@login_with_google');
...
Route::middleware('auth:api')->group(function () {
    ...
    Route::resource('schedules', 'API\ScheduleAPIController');
    Route::resource('partners', 'API\PartnerAPIController');
    Route::resource('businessTypes', 'API\BusinessTypeAPIController');
...
Route::get('terms', 'API\TermsAPIController@index');
